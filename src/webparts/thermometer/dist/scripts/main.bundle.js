define("thermometer", [], function() { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
module.exports.Container = __webpack_require__(31);
module.exports.Mixin = __webpack_require__(33);
module.exports.ReduceStore = __webpack_require__(34);
...
var Thermometer = function (_React$Component) {
    ...
    function Thermometer(props) {
        ...
        return _possibleConstructorReturn(this, (Thermometer.__proto__ || Object.getPrototypeOf(Thermometer)).call(this, props));
    }
...
var _ThermometerActions = __webpack_require__(49);

var _ThermometerActions2 = _interopRequireDefault(_ThermometerActions);

var _ThermometerActionTypes = __webpack_require__(23);

var _ThermometerActionTypes2 = _interopRequireDefault(_ThermometerActionTypes);
...
var ThermometerStore = function (_ReduceStore) {
    _inherits(ThermometerStore, _ReduceStore);

    function ThermometerStore() {
        _classCallCheck(this, ThermometerStore);

        return _possibleConstructorReturn(this, (ThermometerStore.__proto__ || Object.getPrototypeOf(ThermometerStore)).call(this, _dispatcher2.default));
    }

    _createClass(ThermometerStore, [{
        key: 'getInitialState',
        value: function getInitialState() {
            var init = _immutable2.default.Map();
            var originalimage = new Image();
            originalimage.src = "https://asuep.sharepoint.com/sites/DeviLink/Documents/ngcdash.png";
            originalimage.onLoad = _ThermometerActions2.default.LoadImage(originalimage);
            var set = init.merge({
                image: originalimage,
                imageData: ''
            });
        ...
        value: function reduce(state, action) {
            ...
            switch (action.type) {
                ...
                case _ThermometerActionTypes2.default.CROPIMAGE:
                    return state.merge({
    ...
    return ThermometerStore;
}(_utils.ReduceStore);

exports.default = new ThermometerStore();
...
var fbemitter = {
  ...
  EmitterSubscription: __webpack_require__(17)
};
...
var FluxContainerSubscriptions = __webpack_require__(32);
...
var actions = {
    CropImage: function CropImage(image) {
        ...
        _dispatcher2.default.dispatch({
            type: _ThermometerActionTypes2.default.CROPIMAGE,
            image: dataUri
        });
    },
...
var _Thermometer = __webpack_require__(24);
...
var _ThermometerStore = __webpack_require__(25);

var _ThermometerStore2 = _interopRequireDefault(_ThermometerStore);
...
var ThermometerContainer = function (_React$Component) {
    _inherits(ThermometerContainer, _React$Component);

    function ThermometerContainer() {
        _classCallCheck(this, ThermometerContainer);

        return _possibleConstructorReturn(this, (ThermometerContainer.__proto__ || Object.getPrototypeOf(ThermometerContainer)).apply(this, arguments));
    }

    _createClass(ThermometerContainer, [{
        key: 'render',
        value: function render() {

            return _react2.default.createElement(_Thermometer2.default, { actions: this.state.actions, image: this.state.image });
        }
    }], [{
        key: 'getStores',
        value: function getStores() {
            return [_ThermometerStore2.default];
        }
    }, {
        key: 'calculateState',
        value: function calculateState(prevState, props) {
            ...
            return {
                actions: {
                    CropImage: _ThermometerActions2.default.CropImage,
                    LoadImage: _ThermometerActions2.default.LoadImage
                },
                image: _ThermometerStore2.default.getState().get('imageData')
            };
        }
    }]);
...
exports.default = _utils2.default.Container.create(ThermometerContainer);
...
exports.default = window['globalDispatcher'] ? window['globalDispatcher'] : new _flux.Dispatcher();
